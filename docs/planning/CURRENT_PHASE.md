...
- Phase: AI-4
- Name: OpenRouter Catalogue and Free-Only Adapter
- Prompt ID: `CLH-AI-4-OPENROUTER-CATALOGUE-FREE-ADAPTER`
...
- AI-4 boundary:
  VALIDATED DYNAMIC OPENROUTER CATALOGUE, LAST-VALID CACHE, FREE-ONLY
  ELEVEN-ACTION RANKING, USER-OWNED OPENROUTER CREDENTIALS, IMMUTABLE
  FREE-MODEL SNAPSHOTS, FIXED STRUCTURED-OUTPUT ADAPTER, PROVIDER ISOLATION,
  SAFE MODELS/ADMIN-REFRESH APIS, MOCKED VERIFICATION, AND UNCHANGED DIRECT
  GEMINI COMPATIBILITY; NO PAID MODEL, PAID FALLBACK, FRONTEND, LIVE PROVIDER
  CALL, REAL CREDENTIAL, PACKAGE CHANGE, CLOUD ACTION, DEPLOYMENT, PUSH,
  PULL REQUEST, MERGE, AI-5, OR PHASE 19 ACTION
