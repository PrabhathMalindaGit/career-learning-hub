...
- Phase: AI-3
- Name: Vault, Preference, API, and Migration Foundation
...
- AI-3 boundary:
  SECURE VAULT, OWNER-SCOPED CREDENTIAL AND PREFERENCE PERSISTENCE/APIS,
  IMMUTABLE DIRECT-GEMINI/DISABLED ROUTING SNAPSHOTS, EXECUTION LEASES,
  SECURITY AUDIT, AND ENVIRONMENT-GEMINI MIGRATION/ROLLBACK FOUNDATION;
  GEMINI DIRECT REMAINS THE ONLY CALLABLE PROVIDER; NO FRONTEND, SECOND
  PROVIDER, LIVE PROVIDER CALL, REAL CREDENTIAL, CLOUD CHANGE, DEPLOYMENT,
  PUSH, PULL REQUEST, MERGE, PHASE 19 ACTION, OR AI-4 WORK
