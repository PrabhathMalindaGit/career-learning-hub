...
// Feature 4.6 — Type-aware Interview answer input; Coding answers are text-only and never executed.
// Feature 4.9 — “Save attempt” persists each practice submission as a separate attempt.
